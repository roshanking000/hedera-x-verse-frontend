  ...
  return (
    <div className='page-header flex-1 flex flex-col'>
      <div className='results-bar flex items-center justify-between py-3 px-5 bg-navy_medium'>
        <div className='font-Lato font-semibold'>Your bundles</div>
        <button className='px-5 py-2 bg-primary text-white'>Create bundle</button>
...
const BorrowBundleComponent = () => {
  return (
    <section className='flex flex-col gap-5 py-10'>
      <CurrentBundleAsBorrower />
    </section>
  )
}

export default BorrowBundleComponent
